...
(function () {
  ...
  var CSS = [
    ...
    '#khl .pin{position:sticky;top:var(--khl-top,0px);height:calc(100svh - var(--khl-top,0px));display:grid;align-content:center;align-content:safe center;padding:0 var(--pad)}',
